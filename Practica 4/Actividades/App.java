...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            System.out.println("6. Media de toda matriz");
            ...
            switch (opcion) {
                ...
                case 3:
                    if (rellenado) {
                        ...
                        System.out.println("la suma de los valores de la columna es " + columna
                ...
                case 4:
                    if (rellenado) {
                        System.out.println("La suma de los valores de la diagonal es: " + sumarDiagonal(matriz));
                    } else {
                        System.out.println("Debes rellenar la matriz primero");
                    }
                    break;
                case 5:
                    if (rellenado) {
                        System.out.println(
                                "La suma de los valores de la diagonal inversa es: " + sumarDiagonalInversa(matriz));
                    } else {
                        System.out.println("Debes rellenar la matriz primero");
                    }
                    break;
                case 6:
                    if (rellenado) {
                        System.out.println("la media de los valores de la matriz es: " + calcMediaMatriz(matriz));
                    } else {
                        System.out.println("Debes rellenar la matriz primero");
    ...
    public static int sumarDiagonalInversa(int[][] matriz) {
        int suma = 0;
        for (int[] i = { 0, 3 }; (i[0] < matriz.length && i[1] >= 0); i[0]++, i[1]--) {
            suma += matriz[i[0]][i[1]];
        }
        return suma;
    }

    public static double calcMediaMatriz(int[][] matriz) {
        int suma = 0;
        int cantElements = 0;
        for (int[] fila : matriz) {
        ...
        double media = (double) suma / cantElements;
        return media;
    }
}
