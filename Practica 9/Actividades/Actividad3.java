...
public class Binarios2 {
 ...
 do{
 System.out.print("Nimero de filas: ");
 filas = sc.nextInt();
 }while(filas <= 0);
 do{
 System.out.print("Nimero de columnas: ");
 columnas = sc.nextInt();
 }while(columnas <= 0);
 ...
 fos = new
FileOutputStream("C:\\Users\\user\\Documents\\NetBeansProjects\\Binarios2/matriz.
dat");
 salida = new DataOutputStream(fos);

 //escribir el nGmero de filas y columnas en el fichero
